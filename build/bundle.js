/******/ (function(modules) { // webpackBootstrap
	...
	/******/ 	var hotCurrentHash = "de1f682b4e71d35a97c8"; // eslint-disable-line no-unused-vars
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		/* WEBPACK VAR INJECTION */(function(module) {/* REACT HOT LOADER */ if (true) { (function () { var ReactHotAPI = __webpack_require__(5), RootInstanceProvider = __webpack_require__(13), ReactMount = __webpack_require__(15), React = __webpack_require__(69); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
			...
			var _componentsTalkIndex = __webpack_require__(245);

			var _componentsTalkIndex2 = _interopRequireDefault(_componentsTalkIndex);

			var _componentsSkillIndex = __webpack_require__(246);

			var _componentsSkillIndex2 = _interopRequireDefault(_componentsSkillIndex);

			var _componentsLogin = __webpack_require__(240);

			var _componentsLogin2 = _interopRequireDefault(_componentsLogin);

			var _componentsSubArticle = __webpack_require__(241);

			var _componentsSubArticle2 = _interopRequireDefault(_componentsSubArticle);

			exports['default'] = _react2['default'].createElement(_reactRouter.Route, { name: 'app', handler: _componentsApp2['default'] }, _react2['default'].createElement(_reactRouter.Route, { name: 'home', path: '/', handler: _componentsHome2['default'] }), _react2['default'].createElement(_reactRouter.Route, { name: 'skillPage', path: '/skill', handler: _componentsSkillIndex2['default'] }), _react2['default'].createElement(_reactRouter.Route, { name: 'talkPage', path: '/talk', handler: _componentsTalkIndex2['default'] }), _react2['default'].createElement(_reactRouter.Route, { name: 'login', path: '/login', handler: _componentsLogin2['default'] }), _react2['default'].createElement(_reactRouter.Route, { name: 'subArticle', path: '/subArticle', handler: _componentsSubArticle2['default'] }));
		...
		/* WEBPACK VAR INJECTION */(function(module) {/* REACT HOT LOADER */ if (true) { (function () { var ReactHotAPI = __webpack_require__(5), RootInstanceProvider = __webpack_require__(13), ReactMount = __webpack_require__(15), React = __webpack_require__(69); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
			...
			var App = (function (_React$Component) {
				...
				_createClass(App, [{
					key: 'render',
					value: function render() {
						return _react2['default'].createElement('div', null, _react2['default'].createElement(_Navbar2['default'], null), _react2['default'].createElement(_reactRouter.RouteHandler, null));
					}
				}]);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		/* WEBPACK VAR INJECTION */(function(module) {/* REACT HOT LOADER */ if (true) { (function () { var ReactHotAPI = __webpack_require__(5), RootInstanceProvider = __webpack_require__(13), ReactMount = __webpack_require__(15), React = __webpack_require__(69); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
			...
			var _StoresNavbarStore = __webpack_require__(216);

			var _StoresNavbarStore2 = _interopRequireDefault(_StoresNavbarStore);

			var _ActionsNavbarActions = __webpack_require__(233);
			...
			var Navbar = (function (_React$Component) {
				...
				_createClass(Navbar, [{
					...
					value: function componentDidMount() {
						...
						window.NavbarS1 = _ActionsNavbarActions2['default'];
					...
					key: 'render',
					value: function render() {
						return _react2['default'].createElement('nav', { className: 'navbar navbar-default navbar-static-top' }, _react2['default'].createElement('div', { className: 'navbar-content' }, _react2['default'].createElement('div', { className: 'navbar-header' }, _react2['default'].createElement(_reactRouter.Link, { to: '/', className: 'navbar-brand' }, 'RESTLIFE', _react2['default'].createElement('span', { className: 'badge badge-up badge-danger' }, this.state.onlineUsers))), _react2['default'].createElement('div', { id: 'navbar', className: 'navbar-collapse collapse' }, _react2['default'].createElement('ul', { className: 'nav navbar-nav pull-right' }, _react2['default'].createElement('li', null, _react2['default'].createElement(_reactRouter.Link, { to: '/talk' }, '杂谈')), _react2['default'].createElement('li', null, _react2['default'].createElement(_reactRouter.Link, { to: '/skill' }, 'skill')), _react2['default'].createElement('li', null, _react2['default'].createElement(_reactRouter.Link, { to: '/about' }, '关于我'))))));
					}
				}]);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		/* WEBPACK VAR INJECTION */(function(module) {/* REACT HOT LOADER */ if (true) { (function () { var ReactHotAPI = __webpack_require__(5), RootInstanceProvider = __webpack_require__(13), ReactMount = __webpack_require__(15), React = __webpack_require__(69); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
			...
			var _alt = __webpack_require__(217);
			...
			/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(230); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "NavbarStore.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
			/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		/* WEBPACK VAR INJECTION */(function(module) {/* REACT HOT LOADER */ if (true) { (function () { var ReactHotAPI = __webpack_require__(5), RootInstanceProvider = __webpack_require__(13), ReactMount = __webpack_require__(15), React = __webpack_require__(69); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
			...
			/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(230); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "alt.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
			/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var _utilsStateFunctions = __webpack_require__(222);

		var StateFunctions = _interopRequireWildcard(_utilsStateFunctions);

		var _utilsFunctions = __webpack_require__(223);
		...
		var _utilsAltUtils = __webpack_require__(225);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var _AltStore = __webpack_require__(226);

		var _AltStore2 = _interopRequireDefault(_AltStore);

		var _StoreMixin = __webpack_require__(228);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var _transmitter = __webpack_require__(227);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		/* WEBPACK VAR INJECTION */(function(module) {/* REACT HOT LOADER */ if (true) { (function () { var ReactHotAPI = __webpack_require__(5), RootInstanceProvider = __webpack_require__(13), ReactMount = __webpack_require__(15), React = __webpack_require__(69); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
			...
			/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(230); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "NavbarActions.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
			/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		/* WEBPACK VAR INJECTION */(function(module) {/* REACT HOT LOADER */ if (true) { (function () { var ReactHotAPI = __webpack_require__(5), RootInstanceProvider = __webpack_require__(13), ReactMount = __webpack_require__(15), React = __webpack_require__(69); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
			...
			var _StoresHomeStore = __webpack_require__(235);

			var _StoresHomeStore2 = _interopRequireDefault(_StoresHomeStore);

			var _ActionsHomeActions = __webpack_require__(236);

			var _ActionsHomeActions2 = _interopRequireDefault(_ActionsHomeActions);

			var _ArtOperate = __webpack_require__(237);

			var _ArtOperate2 = _interopRequireDefault(_ArtOperate);
			...
			var Home = (function (_React$Component) {
				...
				_createClass(Home, [{
					...
					key: 'changePage',
					value: function changePage(pageCurrent) {
						var _this = this;
						var pageKind = this.props.pageKind;
						_ActionsHomeActions2['default'].updataPageCurrent(parseInt(pageCurrent));
						setTimeout(function () {
							$.ajax({
								url: '/homePage',
								type: 'POST',
								...
								success: function success(data) {
									...
									var first,
										...
										pageTotal = Math.ceil(pageAll / _this.state.pageLimit);
									...
									_ActionsHomeActions2['default'].updataFirstLast(pageFirstLast);
									_ActionsHomeActions2['default'].page(data.data);
								}
							});
						}, 1);
					}
					...
					value: function render() {
						...
						for (var i = this.state.first; i <= this.state.last; i++) {
							if (i == this.state.first) {
								articleNum.push(_react2['default'].createElement('li', { onClick: this.changePage.bind(this, i) }, _react2['default'].createElement('a', null, '«')));
							}
							articleNum.push(_react2['default'].createElement('li', null, _react2['default'].createElement('a', { onClick: this.changePage.bind(this, i) }, i)));
							if (i == this.state.last) {
								articleNum.push(_react2['default'].createElement('li', { onClick: this.changePage.bind(this, i) }, _react2['default'].createElement('a', null, '»')));
							}
						}
						var articleList = this.state.page.map(function (article, index) {
							return _react2['default'].createElement('div', { className: 'article-list' }, _react2['default'].createElement('p', { className: 'article-tit' }, _react2['default'].createElement('a', null, article.title)), _react2['default'].createElement('div', { className: 'article-message' }, _react2['default'].createElement('div', { className: 'icon-font-content' }, _react2['default'].createElement('i', { className: 'icon-user' }), _react2['default'].createElement('span', { className: 'article-author' }, article.author)), _react2['default'].createElement('div', { className: 'icon-font-content' }, _react2['default'].createElement('i', { className: 'icon-clock2' }), _react2['default'].createElement('span', { className: 'article-author' }, article.time))), _react2['default'].createElement('div', { className: 'article-stage' }, article.content), _react2['default'].createElement('div', null, _react2['default'].createElement(_ArtOperate2['default'], { changePage: _this2.changePage.bind(_this2, _this.state.pageCurrent), good: article.good, look: article.look, index: index, id: article._id })));
						});

						return _react2['default'].createElement('div', { className: 'home-content clearfix' }, _react2['default'].createElement('div', { className: 'pull-left home-left' }, _react2['default'].createElement('section', { className: 'article-content' }, articleList), _react2['default'].createElement('nav', null, _react2['default'].createElement('ul', { className: 'pagination' }, articleNum))), _react2['default'].createElement('div', { className: 'pull-left home-right' }));
					}
				}]);
		...
		/* WEBPACK VAR INJECTION */(function(module) {/* REACT HOT LOADER */ if (true) { (function () { var ReactHotAPI = __webpack_require__(5), RootInstanceProvider = __webpack_require__(13), ReactMount = __webpack_require__(15), React = __webpack_require__(69); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
			...
			var HomeStore = (function () {
				...
				_createClass(HomeStore, [{
					key: 'onUpdataPage',
					value: function onUpdataPage(data) {
						this.pagetotal = data.pagetotal;
						this.pageNum = Math.ceil(this.pagetotal / this.pageLimit);
					}
				}, {
					key: 'onUpdataFirstLast',
					value: function onUpdataFirstLast(data) {
						this.first = data.first;
						this.last = data.last;
					}
				}, {
					key: 'onUpdataPageCurrent',
					value: function onUpdataPageCurrent(num) {
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		/* WEBPACK VAR INJECTION */(function(module) {/* REACT HOT LOADER */ if (true) { (function () { var ReactHotAPI = __webpack_require__(5), RootInstanceProvider = __webpack_require__(13), ReactMount = __webpack_require__(15), React = __webpack_require__(69); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
			...
			/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(230); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "HomeActions.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
			/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		/* WEBPACK VAR INJECTION */(function(module) {/* REACT HOT LOADER */ if (true) { (function () { var ReactHotAPI = __webpack_require__(5), RootInstanceProvider = __webpack_require__(13), ReactMount = __webpack_require__(15), React = __webpack_require__(69); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
			...
			var _StoresArtOperateStore = __webpack_require__(238);

			var _StoresArtOperateStore2 = _interopRequireDefault(_StoresArtOperateStore);

			var _ActionsArtOperateActions = __webpack_require__(239);

			var _ActionsArtOperateActions2 = _interopRequireDefault(_ActionsArtOperateActions);

			var ArtOperate = (function (_React$Component) {
				_inherits(ArtOperate, _React$Component);

				function ArtOperate(props) {
					_classCallCheck(this, ArtOperate);

					_get(Object.getPrototypeOf(ArtOperate.prototype), 'constructor', this).call(this, props);
					this.state = _StoresArtOperateStore2['default'].getState();
					this.onChange = this.onChange.bind(this);
				}

				_createClass(ArtOperate, [{
					key: 'componentDidMount',
					value: function componentDidMount() {
						_StoresArtOperateStore2['default'].listen(this.onChange);
						var _this = this;
						setTimeout(function () {
							_ActionsArtOperateActions2['default'].updataGood(_this.props.good);
							_ActionsArtOperateActions2['default'].updataLook(_this.props.look);
						}, 1);
					}
				}, {
					key: 'componentWillUnmount',
					value: function componentWillUnmount() {
						_StoresArtOperateStore2['default'].unlisten(this.onChange);
					}
				}, {
					key: 'onChange',
					value: function onChange(state) {
					...
					key: 'render',
					value: function render() {
						return _react2['default'].createElement('div', { className: 'article-operate', 'data-id': this.props.id, id: "chooseId" + this.props.index }, _react2['default'].createElement('div', { className: 'icon-font-content', onClick: this.addGood.bind(this, this.props.index) }, _react2['default'].createElement('i', { className: 'icon-like' }), _react2['default'].createElement('span', null, this.props.good)), _react2['default'].createElement('div', { className: 'icon-font-content' }, _react2['default'].createElement('i', { className: 'icon-eye' }), _react2['default'].createElement('span', null, this.props.look)));
					}
				}]);
			...
			exports['default'] = ArtOperate;
			module.exports = exports['default'];

			/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(230); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "ArtOperate.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
			/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		/* WEBPACK VAR INJECTION */(function(module) {/* REACT HOT LOADER */ if (true) { (function () { var ReactHotAPI = __webpack_require__(5), RootInstanceProvider = __webpack_require__(13), ReactMount = __webpack_require__(15), React = __webpack_require__(69); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
			...
			var ArtOperateStore = (function () {
				function ArtOperateStore() {
					_classCallCheck(this, ArtOperateStore);

					this.bindActions(_ActionsArtOperateActions2['default']);
					this.good = 0;
					this.look = 0;
				}

				_createClass(ArtOperateStore, [{
					key: 'onUpdataLook',
					value: function onUpdataLook(data) {
						this.look = data;
					}
				}, {
					key: 'onUpdataGood',
					value: function onUpdataGood(data) {
						this.good = data;
					}
				}]);

				return ArtOperateStore;
			})();

			exports['default'] = _alt2['default'].createStore(ArtOperateStore);
			module.exports = exports['default'];

			/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(230); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "ArtOperateStore.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
			/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		/* WEBPACK VAR INJECTION */(function(module) {/* REACT HOT LOADER */ if (true) { (function () { var ReactHotAPI = __webpack_require__(5), RootInstanceProvider = __webpack_require__(13), ReactMount = __webpack_require__(15), React = __webpack_require__(69); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
			...
			var ArtOperateActions = function ArtOperateActions() {
				_classCallCheck(this, ArtOperateActions);

				this.generateActions('updataGood', 'updataLook');
			};

			exports['default'] = _alt2['default'].createActions(ArtOperateActions);
			module.exports = exports['default'];

			/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(230); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "ArtOperateActions.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
			/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		/* WEBPACK VAR INJECTION */(function(module) {/* REACT HOT LOADER */ if (true) { (function () { var ReactHotAPI = __webpack_require__(5), RootInstanceProvider = __webpack_require__(13), ReactMount = __webpack_require__(15), React = __webpack_require__(69); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
			...
			var _StoresSubArticleStore = __webpack_require__(242);

			var _StoresSubArticleStore2 = _interopRequireDefault(_StoresSubArticleStore);

			var _ActionsSubArticleActions = __webpack_require__(243);

			var _ActionsSubArticleActions2 = _interopRequireDefault(_ActionsSubArticleActions);

			/*import Article from 'Article'*/

			var SubArticle = (function (_React$Component) {
				_inherits(SubArticle, _React$Component);

				function SubArticle(props) {
					_classCallCheck(this, SubArticle);

					_get(Object.getPrototypeOf(SubArticle.prototype), 'constructor', this).call(this, props);
					this.state = _StoresSubArticleStore2['default'].getState();
					this.onChange = this.onChange.bind(this);
				}

				_createClass(SubArticle, [{
					key: 'componentDidMount',
					value: function componentDidMount() {
						_StoresSubArticleStore2['default'].listen(this.onChange);
					}
				}, {
					key: 'componentWillUnmount',
					value: function componentWillUnmount() {
						_StoresSubArticleStore2['default'].unlisten(this.onChange);
					}
				}, {
					key: 'onChange',
					value: function onChange(state) {
					...
					key: 'render',
					value: function render() {
						return _react2['default'].createElement('div', { className: 'home-content clearfix' }, _react2['default'].createElement('form', { role: 'form', onSubmit: this.handleSubmit.bind(this) }, _react2['default'].createElement('div', { className: 'form-group' }, _react2['default'].createElement('label', { 'for': 'exampleInputEmail1' }, '文章标题'), _react2['default'].createElement('input', { type: 'text', className: 'form-control', ref: 'InputTitle', placeholder: '输入标题', value: this.state.name, onChange: _ActionsSubArticleActions2['default'].updateName })), _react2['default'].createElement('div', { className: 'form-group' }, _react2['default'].createElement('label', { 'for': 'InputContent' }, '文章内容'), _react2['default'].createElement('div', null, _react2['default'].createElement('textarea', { 'class': 'form-control', rows: '3', value: this.state.content, onChange: _ActionsSubArticleActions2['default'].updataContent }))), _react2['default'].createElement('select', { className: 'form-control', value: this.state.kind, onChange: _ActionsSubArticleActions2['default'].updataSelect }, _react2['default'].createElement('option', { value: '1' }, '杂谈'), _react2['default'].createElement('option', { value: '2' }, 'skill')), _react2['default'].createElement('button', { type: 'submit', className: 'btn btn-default' }, '提交')));
					}
				}]);
			...
			exports['default'] = SubArticle;
			module.exports = exports['default'];

			/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(230); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "SubArticle.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
			/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		/* WEBPACK VAR INJECTION */(function(module) {/* REACT HOT LOADER */ if (true) { (function () { var ReactHotAPI = __webpack_require__(5), RootInstanceProvider = __webpack_require__(13), ReactMount = __webpack_require__(15), React = __webpack_require__(69); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
			...
			var SubArticleStore = (function () {
				function SubArticleStore() {
					_classCallCheck(this, SubArticleStore);

					this.bindActions(_ActionsSubArticleActions2['default']);
					this.name = '';
					this.content = '';
					this.kind = '1';
				}

				_createClass(SubArticleStore, [{
					key: 'onUpdateName',
					...
					key: 'onUpdataContent',
					value: function onUpdataContent(e) {
					...
					key: 'onUpdataSelect',
					value: function onUpdataSelect(e) {
						var select = e.target.value;
						this.kind = select;
					}
				}]);

				return SubArticleStore;
			})();

			exports['default'] = _alt2['default'].createStore(SubArticleStore);
			module.exports = exports['default'];

			/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(230); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "SubArticleStore.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
			/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		/* WEBPACK VAR INJECTION */(function(module) {/* REACT HOT LOADER */ if (true) { (function () { var ReactHotAPI = __webpack_require__(5), RootInstanceProvider = __webpack_require__(13), ReactMount = __webpack_require__(15), React = __webpack_require__(69); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
			...
			var SubArticleActions = function SubArticleActions() {
				_classCallCheck(this, SubArticleActions);

				this.generateActions('updateName', 'updataContent', 'updataSelect');
			};

			exports['default'] = _alt2['default'].createActions(SubArticleActions);
			module.exports = exports['default'];

			/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(230); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "SubArticleActions.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
			/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		/* WEBPACK VAR INJECTION */(function(module) {/* REACT HOT LOADER */ if (true) { (function () { var ReactHotAPI = __webpack_require__(5), RootInstanceProvider = __webpack_require__(13), ReactMount = __webpack_require__(15), React = __webpack_require__(69); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
			...
			var TalkIndex = (function (_React$Component) {
				_inherits(TalkIndex, _React$Component);

				function TalkIndex(props) {
					_classCallCheck(this, TalkIndex);

					_get(Object.getPrototypeOf(TalkIndex.prototype), 'constructor', this).call(this, props);
				}

				_createClass(TalkIndex, [{
					key: 'render',
					value: function render() {
						return _react2['default'].createElement('div', null, _react2['default'].createElement(_Home2['default'], { pageKind: '1' }));
					}
				}]);
			...
			exports['default'] = TalkIndex;
			module.exports = exports['default'];

			/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(230); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "TalkIndex.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
			/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		/* WEBPACK VAR INJECTION */(function(module) {/* REACT HOT LOADER */ if (true) { (function () { var ReactHotAPI = __webpack_require__(5), RootInstanceProvider = __webpack_require__(13), ReactMount = __webpack_require__(15), React = __webpack_require__(69); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
			...
			var SkillIndex = (function (_React$Component) {
				_inherits(SkillIndex, _React$Component);

				function SkillIndex(props) {
					_classCallCheck(this, SkillIndex);

					_get(Object.getPrototypeOf(SkillIndex.prototype), 'constructor', this).call(this, props);
				}

				_createClass(SkillIndex, [{
					key: 'render',
					value: function render() {
						return _react2['default'].createElement('div', null, _react2['default'].createElement(_Home2['default'], { pageKind: '2' }));
					}
				}]);
			...
			exports['default'] = SkillIndex;
			module.exports = exports['default'];

			/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(230); if (makeExportsHot(module, __webpack_require__(69))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot apply hot update to " + "SkillIndex.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
			/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4)(module)))
